...
class Main:
    ...
    def load(self, cfile=str('avantar.toml')):
        ...
        self.teclemmino.splash_screen() if not str_io else self.teclemmino.start_game_from_root_element()
